...
const BADGE: Record<Platform, string> = {
  ...
  cursor: 'bg-amber-500/10 text-amber-600 border-amber-500/30 dark:text-amber-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  cursor: 'bg-amber-500/10 text-amber-600 dark:bg-amber-500/10 dark:text-amber-300',
...
const TEXT: Record<Platform, string> = {
  ...
  cursor: 'text-amber-600 dark:text-amber-300',
...
const ICON: Record<Platform, string> = {
  ...
  cursor: 'text-amber-500 dark:text-amber-300',
  grok: 'text-zinc-800 dark:text-zinc-200',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  cursor: 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  cursor: 'from-amber-400 to-amber-500',
