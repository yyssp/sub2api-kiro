...
// 仅用于展示排序；未列出的平台 indexOf 为 -1 会排到最前，因此新增平台要补进来。
const PLATFORM_ORDER: PlatformQuotaPlatform[] = ['anthropic', 'openai', 'gemini', 'antigravity', 'kiro', 'cursor', 'grok', 'kimi', 'zhipu', 'deepseek', 'minimax']
