...
// ── Platform config ──
const platformOrder: GroupPlatform[] = ['anthropic', 'openai', 'gemini', 'antigravity', 'kiro', 'cursor', 'grok', 'kimi', 'zhipu', 'deepseek', 'minimax', 'opencode_go']
...
const compositePlatforms: GroupPlatform[] = ['anthropic', 'openai', 'gemini', 'antigravity', 'kiro', 'cursor', 'grok', 'kimi', 'zhipu', 'deepseek', 'minimax', 'opencode_go']
