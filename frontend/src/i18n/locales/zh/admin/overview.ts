export default {
    ...
    groups: {
      ...
      form: {
        ...
        platform: '平台',
        cacheStrategy: '缓存策略',
        noCacheStrategy: '不绑定缓存策略',
        cacheStrategyHint: '一个分组只能绑定一个缓存策略；也可在缓存策略页面管理绑定。',
        rateMultiplier: '费率倍数',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
      ...
      CACHE_STRATEGY_NOT_FOUND: '所选缓存策略不存在，请刷新后重新选择。',
      CACHE_STRATEGY_GROUP_CONFLICT:
        '分组 {group_name}（ID {group_id}）已绑定缓存策略 {current_strategy_id}，不能改绑到策略 {requested_strategy_id}。请先在原策略页面解除绑定。',
