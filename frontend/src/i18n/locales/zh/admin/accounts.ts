export default {
    accounts: {
      ...
      kiroImportTitle: '导入 Kiro 账号',
      kiroImportSource: '导入来源',
      kiroImportTabJson: 'JSON',
      kiroImportTabApiKey: 'ksk 密钥',
      kiroImportTabToken: 'Token',
      kiroImportTabKiroIde: 'Kiro IDE 导出',
      kiroImportHintJson: '自动识别单个对象、数组、JSONL 多行，以及 accounts / credentials 包装格式；兼容 KAM 新版平铺与旧版嵌套结构。字段支持 camelCase / snake_case / kebab-case，时间戳自动转换，region 可从 profileArn 反解。缺失的 authMethod、machineId、region、endpoint 会自动补齐。',
      kiroImportHintApiKey: '每行一个 API 密钥，格式为 `ksk_xxx` 或 `ksk_xxx|区域`。井号开头的行视为注释。',
      kiroImportHintToken: '每行一个 refreshToken，可用 `token|区域` 指定区域。井号开头的行视为注释。',
      kiroImportHintKiroIde: '支持 Kiro IDE 导出的凭证 JSON，需要同时包含 accessToken、refreshToken 与运行时元数据（校验严格，不做自动补齐）。',
      kiroImportFile: '凭证文件',
      kiroImportSelectFile: '请选择凭证文件',
      kiroImportContent: '凭证内容',
      kiroImportParse: '解析并预览',
      kiroImportPreview: '解析结果（共 {count} 个账号）',
      kiroImportSkipDisabled: '跳过已禁用的凭证',
      kiroImportColName: '账号名称',
      kiroImportColAuthMethod: '认证方式',
      kiroImportColRegion: '区域',
      kiroImportColEndpoint: '端点',
      kiroImportColStatus: '状态',
      kiroImportEnabled: '启用',
      kiroImportDisabled: '已禁用',
      kiroImportConfirm: '导入 {count} 个账号',
      kiroImportEmpty: '未解析到任何账号',
      kiroImportSkipped: '已跳过 {count} 条无法识别的记录',
      ...
      cursorImportParse: '解析并预览',
      cursorImportPreview: '解析结果（共 {count} 个账号）',
      cursorImportSkipDisabled: '跳过已禁用的凭证',
      cursorImportColName: '账号名称',
      cursorImportColTokenType: 'Token 类型',
      cursorImportColExpires: '到期时间',
      cursorImportColStatus: '状态',
      cursorImportEnabled: '启用',
      cursorImportDisabled: '已禁用',
      cursorImportConfirm: '导入 {count} 个账号',
      cursorImportEmpty: '未解析到任何账号',
      cursorImportSkipped: '已跳过 {count} 条无法识别或重复的记录',
      cursorImportShortLivedHint: '其中 {count} 条是 web 类型的短效 token（仅数小时有效），创建时会尝试兑换为长效 token，请尽快确认导入。',
      cursorImportParamsHint: '下方表单的分组、代理、优先级、并发等参数会套用到全部导入的账号。',
      ...
      oauth: {
        ...
        kiro: {
          ...
          importDialogTitle: '导入 Kiro 凭证',
          importSubtitle: '批量导入 JSON / ksk / Token / Kiro IDE 凭证',
          importTitle: '导入凭证',
