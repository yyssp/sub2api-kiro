export default {
    accounts: {
      ...
      kiroImportSourceKiroRs: 'kiro.rs credentials',
      kiroImportSourceKiroIde: 'Kiro IDE export',
      kiroImportHintKiroRs: 'Supports kiro.rs credentials.json: a single object, an array (multiple accounts), or a plain-text list of `ksk_xxx|region` lines. Missing authMethod, machineId, region and endpoint are auto-filled using kiro.rs defaults.',
      kiroImportHintKiroIde: 'Supports credential JSON exported from Kiro IDE, which must include accessToken, refreshToken and runtime metadata.',
