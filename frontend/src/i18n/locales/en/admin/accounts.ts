export default {
    accounts: {
      ...
      kiroImportSource: 'Import source',
      kiroImportTabJson: 'JSON',
      kiroImportTabApiKey: 'ksk keys',
      kiroImportTabToken: 'Token',
      kiroImportTabKiroIde: 'Kiro IDE export',
      kiroImportHintJson: 'Automatically detects single objects, arrays, multi-line JSONL, and accounts / credentials wrappers; compatible with both flat (new) and nested (legacy) KAM structures. Keys may be camelCase, snake_case or kebab-case; timestamps are normalized and region can be derived from profileArn. Missing authMethod, machineId, region and endpoint are auto-filled.',
      kiroImportHintApiKey: 'One API key per line, formatted as `ksk_xxx` or `ksk_xxx|region`. Lines starting with # are treated as comments.',
      kiroImportHintToken: 'One refreshToken per line; use `token|region` to specify a region. Lines starting with # are treated as comments.',
      kiroImportHintKiroIde: 'Supports credential JSON exported from Kiro IDE, which must include accessToken, refreshToken and runtime metadata (strict validation, no auto-fill).',
      kiroImportFile: 'Credential file',
      kiroImportSelectFile: 'Please select a credential file',
      kiroImportContent: 'Credential content',
      kiroImportParse: 'Parse & Preview',
      kiroImportPreview: 'Parsed result ({count} account(s))',
      kiroImportSkipDisabled: 'Skip disabled credentials',
      kiroImportColName: 'Name',
      kiroImportColAuthMethod: 'Auth method',
      kiroImportColRegion: 'Region',
      kiroImportColEndpoint: 'Endpoint',
      kiroImportColStatus: 'Status',
      kiroImportEnabled: 'Enabled',
      kiroImportDisabled: 'Disabled',
      kiroImportConfirm: 'Import {count} account(s)',
      kiroImportEmpty: 'No accounts were parsed',
      kiroImportSkipped: 'Skipped {count} unrecognized record(s)',
      ...
      cursorImportParse: 'Parse & Preview',
      cursorImportPreview: 'Parsed result ({count} account(s))',
      cursorImportSkipDisabled: 'Skip disabled credentials',
      cursorImportColName: 'Name',
      cursorImportColTokenType: 'Token type',
      cursorImportColExpires: 'Expires at',
      cursorImportColStatus: 'Status',
      cursorImportEnabled: 'Enabled',
      cursorImportDisabled: 'Disabled',
      cursorImportConfirm: 'Import {count} account(s)',
      cursorImportEmpty: 'No accounts were parsed',
      cursorImportSkipped: 'Skipped {count} unrecognized or duplicate record(s)',
      cursorImportShortLivedHint: '{count} of them are short-lived web tokens (valid for only a few hours). They will be exchanged for long-lived tokens on creation, so please confirm the import promptly.',
      cursorImportParamsHint: 'Group, proxy, priority, concurrency and other parameters from the form below apply to every imported account.',
      ...
      oauth: {
        ...
        kiro: {
          ...
          importDialogTitle: 'Import Kiro Credentials',
          importSubtitle: 'Bulk import JSON / ksk / Token / Kiro IDE credentials',
