export default {
    ...
    groups: {
      ...
      form: {
        ...
        cacheStrategyHint: 'Each group can use one cache strategy. You can also manage bindings from the cache strategy page.',
        rateMultiplier: 'Rate Multiplier',
        status: 'Status',
      ...
      CACHE_STRATEGY_NOT_FOUND: 'The selected cache strategy does not exist. Refresh and choose it again.',
      CACHE_STRATEGY_GROUP_CONFLICT:
        'Group {group_name} (ID {group_id}) is already bound to cache strategy {current_strategy_id} and cannot be rebound to strategy {requested_strategy_id}. Unbind it from the current strategy first.',
