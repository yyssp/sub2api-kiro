  ...
  cacheStrategies: {
    ...
    templates: {
      ...
      kiroRsTool: {
        name: "kiro-rs-tool",
        description:
          "Full coverage with no token scaling and no creation throttling, so reported usage tracks real prefix hits. Uncached input stays within 32-4096. Suited to tool-heavy Claude Code sessions.",
      },
      highCache: {
