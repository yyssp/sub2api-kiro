export default {
  ...
  redeem: {
    ...
    localTimeZoneHint:
      "Custom time is interpreted in your browser time zone ({timezone}).",
  ...
  usage: {
    ...
    allCacheStrategies: "All cache strategies",
    allTypes: "All Types",
    ...
    cleanup: {
      ...
      errorConfirm:
        "Clear error request logs in the current filter range? This action cannot be undone.",
