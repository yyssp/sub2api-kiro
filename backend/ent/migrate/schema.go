...
var (
	...
	// CacheStrategiesColumns holds the columns for the "cache_strategies" table.
	CacheStrategiesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
	...
	// CacheStrategiesTable holds the schema information for the "cache_strategies" table.
	CacheStrategiesTable = &schema.Table{
		Name:       "cache_strategies",
		Columns:    CacheStrategiesColumns,
		PrimaryKey: []*schema.Column{CacheStrategiesColumns[0]},
	}
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "grok", "antigravity", "kiro", "kimi", "zhipu", "deepseek", "minimax", "cursor", "opencode_go"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "cache_strategy_id", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "cache_strategy_id", Type: field.TypeInt64, Nullable: true},
		{Name: "cache_strategy_name", Type: field.TypeString, Nullable: true, Size: 100},
